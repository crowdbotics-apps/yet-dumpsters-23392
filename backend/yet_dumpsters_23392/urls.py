"""yet_dumpsters_23392 URL Configuration
...
admin.site.site_header = "yet dumpsters"
admin.site.site_title = "yet dumpsters Admin Portal"
admin.site.index_title = "yet dumpsters Admin"

# swagger
api_info = openapi.Info(
    title="yet dumpsters API",
    default_version="v1",
    description="API documentation for yet dumpsters App",
)
